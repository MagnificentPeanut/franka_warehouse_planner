...
from moveit_msgs.srv import GetMotionPlan, GetCartesianPath, GetPlanningScene, GetStateValidity
...
class PickPlaceNode(Node):
    ...
    def plan_to_pose(self, target_pose):
        ...
        req.motion_plan_request.workspace_parameters.max_corner.z = 1.5
        req.motion_plan_request.planner_id = 'RRTConnectConfigDefault'
    ...
    def run_cycle(self):
        ...
        log_file = f"src/franka_warehouse_planner/benchmarks/benchmark_default_rrtconnect_{self.world}_{suffix}.json"

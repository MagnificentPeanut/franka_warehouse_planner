...
def run_benchmark(planner, obstacle, cycles=10):
    print(f"============================================================")
    print(f"Starting Gazebo Physics benchmark: planner={planner}, obstacle={obstacle}")
    print(f"============================================================")
    ...
    cmd = f"source install/setup.bash && ros2 launch franka_pick_place pick_place.launch.py world:=small with_obstacle:={obstacle} cycles:={cycles} planner_id:={planner}"
...
if __name__ == "__main__":
    print("Starting Gazebo Physics-enabled benchmark suite for CHOMP...")
    run_benchmark('CHOMP', 'false', 10)
    run_benchmark('CHOMP', 'true', 10)
    print("All CHOMP benchmarks completed successfully!")

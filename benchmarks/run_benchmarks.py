...
def run_benchmark(obstacle, cycles=10):
    ...
    cmd = f"source install/setup.bash && ros2 launch franka_pick_place pick_place.launch.py world:=large with_obstacle:={obstacle} cycles:={cycles}"
...
if __name__ == "__main__":
    print("Starting full benchmark suite for Phase 4...")
